...
TEST(sha256, double_hash) {
	// Double SHA-256 hash
	const size_t CASE_SIZE = 5U;
	const array<TestCase, CASE_SIZE> doubleCases{{
...
TEST(sha256, hmac) {
	...
	const size_t CASE_SIZE = 10U;
	const array<HmacCase, CASE_SIZE> hmacCases{{  // From RFC 4231
...
TEST(sha256,  stateful_hasher) {
	{ Sha256 h;                                                                                  assert(h.getHash() == Sha256Hash("55B852781B9995A44C939B64E441AE2724B96F99C8F4FB9A141CFC9842C4B0E3")); }
	{ Sha256 h;  ap(h, "a");                                                                     assert(h.getHash() == Sha256Hash("BB48EEAF857780B9724E7C14F8EF86A74DDC239AB331C2FACABD1BCA128197CA")); }
	{ Sha256 h;  ap(h, "a");  ap(h, "bc");                                                       assert(h.getHash() == Sha256Hash("AD1500F261FF10B49C7A1796A36103B02322AE5DDE404141EACF018FBF1678BA")); }
	{ Sha256 h;  ap(h, "ab");  ap(h, "c");                                                       assert(h.getHash() == Sha256Hash("AD1500F261FF10B49C7A1796A36103B02322AE5DDE404141EACF018FBF1678BA")); }
